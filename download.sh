...
wget http://zlib.net/zlib-1.2.8.tar.gz -O zlib.tgz
wget http://web.mit.edu/kerberos/dist/krb5/1.14/krb5-1.14.3.tar.gz -O krb5.tgz
wget https://www.openssl.org/source/openssl-1.0.2.tar.gz -O openssl.tgz
wget https://ftp.postgresql.org/pub/source/v9.5.4/postgresql-9.5.4.tar.gz -O postgresql.tgz
