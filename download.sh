...
wget -nv https://www.openssl.org/source/openssl-1.0.2q.tar.gz -O openssl.tgz
wget -nv https://ftp.postgresql.org/pub/source/v11.1/postgresql-11.1.tar.gz -O postgresql.tgz
wget -nv http://xmlsoft.org/sources/libxml2-2.9.8.tar.gz -O libxml2.tgz
wget -nv http://xmlsoft.org/sources/libxslt-1.1.32.tar.gz -O libxslt.tgz
popd
